...
data.enemies = [
	{
		...
		spread: 1,
		power: 3,
		ascii: "                   (    )<br>                  ((((()))<br>                  |o\ /o)|<br>                  ( (  _')<br>                   (._.  /\__<br>                  ,\___,/ '  ')<br>    '.,_,,       (  .- .   .    )<br>     \   \\     ( '        )(    )<br>      \   \\    \.  _.__ ____( .  |<br>       \  /\\   .(   .'  /\  '.  )<br>        \(  \\.-' ( /    \/    \)<br>         '  ()) _'.-|/\/\/\/\/\|<br>             '\\ .( |\/\/\/\/\/|<br>               '((  \    /\    /<br>               ((((  '.__\/__.')<br>                ((,) /   ((()   )<br>                 '..-,  (()('   /<br>                  _//.   ((() .'<br>          _____ //,/' ___ ((( ', ___<br>                           ((  )<br>                            / /<br>                          _/,/'<br>                        /,/,'"
	},
	{
		name: "",
		health: 10,
	...
	},
	{
		...
		spread: 2,
		power: 1,
		ascii: "                                  <br>                @@                <br>                .                 <br>                `                 <br>                `                 <br>                `                 <br>            .:::;::::`            <br>           +@@@@@@@@@@,           <br>           @@@@@@@@@@@#           <br>           #@@  ,'  @@+           <br>           +@@      '@,           <br>           :@@  `,  @@`           <br>           `@@@@@@@@@@            <br>            @@@@@@@@@@            <br>       @@@@.@@@@@@@@@@,@@@@       <br>       @@@@:@@@@@@@@@@'@@@@       <br>       @@@@+@@@@@@@@@@#@@@#       <br>       @@@@@,@@@@@@@@.@@@@+       <br>   ....#@@@@@`,,,,,,`@@@@@+....   <br>  :@@@@+@@@@@@@@@@@@@@@@@@;@@@@,  <br>  :@@@@;@@@@@@@@@@@@@@@@@@:@@@@,  <br>  :@@  :@@@@@`@: @@@@@@@@@,  @@,  <br>  :@@  .@@@@@@@@#,,@@@:@@@`  @@,  <br>  :@@   @@@@@`.+.. @@@:@@@   @@,  <br>  :@@   @@@:@'##@@@,@..@@@   @@,  <br>  :@@   @@@+@,@@@@@@,@#@@@   @@,  <br>  :@@   @@@,@#@@@@@@#;@.@@   @@,  <br>  :@@   @@@@ @+@@@@@::'`@@   @@.  <br>  :@@   @@@@#@..@@@:@,.'@@   @@,  <br>  :@@   @@@@#@@@``@@@+@@@@   @@,  <br>  +@@   @@@@#,` @.@@@,@@@@   @@'  <br> @   @  @@@@@@@@@@@``@@@@@  @   # <br> #   `. #@@@@@@@@@@@@@@@@@ .    # <br>        '@@@@@@@@@@@@@@@@@        <br>        ,@@@@@@@@@@@@@@@@@        <br>        .+++++++++++++++++        <br>              .@@@@               <br>              .@@@@               <br>              .@@@@               <br>              .@@@@               <br>              .@@@@               <br>              `....               <br>           '##########;           <br>           '##########;           <br>           :'''''''''':           <br>           `         ``           <br>           :'''''''''':           <br>           '##########;           <br>                                  "
	},
	{
		name: "",
		health: 50,
